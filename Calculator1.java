...
class Calculator1 implements ActionListener
{
  ...
  String btn="";
				...
				Calculator1()
				{
				  Frame f=new Frame();
				   ...
				   f.setResizable(false);           // to desable resize button
				 
				  f.setIconImage(Toolkit.getDefaultToolkit().getImage("icon.png"));    //to set left corner icon
				 ...
				 f.setBackground(c);
				  ...
				  tf=new TextField();
				  tf.setFont(new Font("arial",Font.ITALIC,25));
  ...
  {
	  Calculator1 cd=new Calculator1();
  }
